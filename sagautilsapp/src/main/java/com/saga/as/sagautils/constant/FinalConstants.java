...
public class FinalConstants {
    ...
    public static final int pic_maxNumOfPixels_4m = 800*1300;
    
    public static final int pic_minSideLength_2m = 560;
    public static final int pic_maxNumOfPixels_2m = 560*896;
    
    public static final int pic_minSideLength_1m = 480;
    public static final int pic_maxNumOfPixels_1m = 480*640;
    
    public static final int pic_minSideLength_500k = 320;
    public static final int pic_maxNumOfPixels_500k = 320*480;
    ...
    public static final int byte_1m = 4 * 1024 * 1024;
