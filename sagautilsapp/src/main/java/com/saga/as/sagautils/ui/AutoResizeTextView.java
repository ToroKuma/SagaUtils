package tw.com.as.sagautils.ui;
...
import tw.com.as.sagautils.utils.PxUtil;

/**
 * Created by AS on 2016/10/18.
 */
...
public class AutoResizeTextView extends AppCompatTextView {
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle)
    {
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, PxUtil.getDisplayMetrics(getContext()));
        _maxTextSize = getTextSize();
        _paint = new TextPaint(getPaint());

        if (_maxLines == 0) _maxLines = NO_LINE_LIMIT;
